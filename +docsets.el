(use-package! devdocs
  ...
  (my/devdocs-hook js-ts-mode-hook     "javascript" "node" "dom" "htmx~2")
  (my/devdocs-hook web-mode-hook       "html" "css" "django~5.1" "htmx~2")
  (my/devdocs-hook emacs-lisp-mode-hook "elisp")
  :config
  (add-hook 'devdocs-mode-hook #'visual-line-mode)
  (add-hook 'devdocs-mode-hook #'visual-fill-column-mode))
