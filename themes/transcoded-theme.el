...
(def-doom-theme transcoded
  ...
  ((bg         '("#000000" "black" "black" ))
   ...
   (selection      cyan)
   (builtin        magenta)
   (comments       (if transcoded-brighter-comments dark-cyan base5))
   (doc-comments   (doom-lighten (if transcoded-brighter-comments dark-cyan base5) 0.25))
   (constants      green-alt)
   (functions      white)
   (keywords       blue)
   (methods        cyan)
